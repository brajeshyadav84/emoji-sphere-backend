-- ===============================================
-- Create Stored Procedure for Posts with Details - UPDATED VERSION
-- Uses likes_count column from tbl_posts instead of counting from tbl_likes
-- ===============================================
...
-- Create a simpler version for testing (updated to use likes_count from posts)
DELIMITER //
...
-- Create the full version with comments and replies (updated to use likes_count from posts)
DELIMITER //
