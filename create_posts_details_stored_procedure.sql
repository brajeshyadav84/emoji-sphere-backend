-- ===============================================
-- Create Stored Procedure for Posts with Details
-- ===============================================
...
CREATE PROCEDURE emoji_sphere.sp_get_posts_with_details_json1(
    IN p_offset INT,
    IN p_limit INT
)
BEGIN
    ...
    LEFT JOIN (
        SELECT 
            ...
            JSON_ARRAYAGG(
                JSON_OBJECT(
                    'comment_id', c.id,
                    'comment_text', COALESCE(c.content, ''),
